...
struct MatrixOperations {
    ...
    void (*multiply)(const void* a, const void* b, void* result, int rows_a, int cols_a, int cols_b);
    void (*scale)(const void* matrix, const void* scalar, void* result, int size);
    void (*transpose)(const void* matrix, void* result, int rows, int cols);
    void (*fill)(void* matrix, const void* value, int size);
    void (*add_linear_combination)(void* matrix, int base_row, const void* coefficient, int rows, int cols);
};
typedef struct {
    void* data;
    int rows;
