...
static void double_add_linear_combination(void* matrix, int base_row, const void* coefficient,int rows, int cols) {
    double* data = (double*)matrix;
    double coeff = *(const double*)coefficient;
...
MatrixOperations double_matrix_ops = {
    ...
    .fill = double_fill,
    .add_linear_combination = double_add_linear_combination,
};
